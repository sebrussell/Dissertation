...
class Statement
{
	public:
		...
		std::string GetData(std::string _tableName, bool decrypt = false, std::string _columnToDecrypt = "", bool getRest = false, std::string getSpecificColumn = "");
		...
		std::string AddLimit(std::string _limitAmount);
